...
export const CHANNELS = [
  ...
  },
  {
    ...
    uploads: [{ key: "reportCsv", label: "네이버 디스플레이 보고서 CSV·엑셀 (캠페인 이름/비용/노출수/클릭수)", parser: "naverDisplay" }],
  },
  {
  ...
  },
  {
    ...
    title: "브랜드 블로그",
    kpis: [],
    tables: [{ key: "posts", label: "포스팅 현황" }],
    images: [],
    uploads: [
      { key: "postsCsv", label: "포스팅 현황 CSV (업로드 일자/제목/포스팅 링크/조회수/유입 키워드)", parser: "generic", targetTable: "posts" },
    ],
  },
  {
    id: "cafeViral",
