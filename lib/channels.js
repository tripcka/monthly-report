...
export const CHANNELS = [
  {
    ...
    // 인스타그램은 자체 CSV 내보내기가 없어서, "계정 인사이트"/"게시물_릴스 인사이트" 시트를
    // 별도로 만들어 관리하다가 그 시트를 CSV로 내보내 업로드하는 방식을 쓴다.
    uploads: [
      { key: "accountCsv", label: "계정 인사이트 시트 CSV (날짜/팔로워/조회수/반응/프로필활동)", parser: "instagramAccount" },
      { key: "postsReelsCsv", label: "게시물_릴스 인사이트 시트 CSV (업로드일/유형/주제/조회수/도달수 등)", parser: "instagramPosts" },
